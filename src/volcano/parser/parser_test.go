...
SELECT p.name FROM cities c RIGHT JOIN people p ON p.city = c.name AND p.favorite_city = c.name`,
		...
		},
		{
			...
			want: logical.NewMap(
				...
				logical.NewGroupBy(
					...
					[]common.VariableName{"p.name", "myage", "p.surname", "mysurname"},
					[]logical.Aggregate{logical.CountDistinct, logical.First, logical.First, logical.First},
					[]common.VariableName{"", "firstage", "p.surname", "mysurname"},
				),
				false,
			),
			wantErr: false,
		...
		//			"func",
		//			map[common.VariableName]logical.TableValuedFunctionArgumentValue{
		//				common.NewVariableName("arg0"): logical.NewTableValuedFunctionArgumentValueTable(logical.NewDataSource("test1", "")),
		//				common.NewVariableName("arg1"): logical.NewTableValuedFunctionArgumentValueExpression(logical.NewConstant("test")),
		//				common.NewVariableName("arg2"): logical.NewTableValuedFunctionArgumentValueExpression(logical.NewConstant(2)),
		//				common.NewVariableName("arg3"): logical.NewTableValuedFunctionArgumentValueExpression(logical.NewInterval(
		//					logical.NewConstant(2),
		//					logical.NewConstant("hour"),
		//				)),
		//				common.NewVariableName("arg4"): logical.NewTableValuedFunctionArgumentValueDescriptor("test2.test3"),
		//			},
		//		),
		//	),
		//	wantErr: false,
