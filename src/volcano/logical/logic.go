...
type Formula interface {
	Physical(ctx context.Context, physicalCreator *PhysicalPlanCreator) (physical.Formula, common.Variables, error)
}
...
func (f *BooleanConstant) Physical(ctx context.Context, physicalCreator *PhysicalPlanCreator) (physical.Formula, common.Variables, error) {
	return physical.NewConstant(f.Value), common.NoVariables(), nil
}
...
func (f *InfixOperator) Physical(ctx context.Context, physicalCreator *PhysicalPlanCreator) (physical.Formula, common.Variables, error) {
...
func (f *PrefixOperator) Physical(ctx context.Context, physicalCreator *PhysicalPlanCreator) (physical.Formula, common.Variables, error) {
...
func (f *Predicate) Physical(ctx context.Context, physicalCreator *PhysicalPlanCreator) (physical.Formula, common.Variables, error) {
	left, leftVariables, err := f.Left.Physical(ctx, physicalCreator)
	if err != nil {
		return nil, nil, errors.Wrap(err, "couldn't get physical plan for left operand")
	}
