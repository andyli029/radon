...
var FuncInt = execution.Function{
	...
	Description: common.Text("Converts x to an Integer."),
	Validator: All(
		ExactlyNArgs(1),
		Arg(0,
			SingleOneOf(
...
var FuncFloat = execution.Function{
	...
	Description: common.Text("Converts x to a Float."),
	Validator: All(
		ExactlyNArgs(1),
		Arg(0,
			SingleOneOf(
...
var FuncNegate = execution.Function{
	...
	Description: common.Text("Returns x multiplied by -1."),
	Validator: All(
		ExactlyNArgs(1),
		Arg(0,
			SingleOneOf(
...
var FuncAbs = execution.Function{
	...
	Description: common.Text("Returns the absolute value of x."),
	Validator: All(
		ExactlyNArgs(1),
		Arg(0,
			SingleOneOf(
...
var FuncSqrt = execution.Function{
	...
	Description: common.Text("Returns the square root of x."),
	Validator: All(
		ExactlyNArgs(1),
		Arg(0,
			SingleOneOf(
...
var FuncFloor = execution.Function{
	...
	Description: common.Text("Returns the floor of x."),
	Validator: All(
		ExactlyNArgs(1),
		Arg(0,
			SingleOneOf(
...
var FuncCeil = execution.Function{
	...
	Description: common.Text("Returns the ceiling of x."),
	Validator: All(
		ExactlyNArgs(1),
		Arg(0,
			SingleOneOf(
...
var FuncLog2 = execution.Function{
	...
	Description: common.Text("Returns the logarithm base 2 of x."),
	Validator: All(
		ExactlyNArgs(1),
		Arg(0,
			SingleOneOf(
...
var FuncLn = execution.Function{
	...
	Description: common.Text("Returns the natural logarithm of x."),
	Validator: All(
		ExactlyNArgs(1),
		Arg(0,
			SingleOneOf(
...
var FuncLeast = execution.Function{
	...
	Description: common.Text("Returns the least argument."),
	Validator: All(
		AtLeastNArgs(1),
		OneOf(
...
var FuncGreatest = execution.Function{
	...
	Description: common.Text("Returns the greatest argument."),
	Validator: All(
		AtLeastNArgs(1),
		OneOf(
			AllArgs(TypeOf(ZeroInt())),
...
var FuncRandFloat = execution.Function{
	...
	Description: common.List(
		common.Text("Provided no arguments, returns a pseudo-random Float in [0.0,1.0)."),
		common.Text("Provided one argument, returns a pseudo-random Float in [0.0,max)."),
		common.Text("Provided two arguments, returns a pseudo-random Float in [min,max)."),
	),
	Validator: All(
		AtMostNArgs(2),
		AllArgs(TypeOf(ZeroInt())),
...
var FuncRandInt = execution.Function{
	...
	Description: common.List(
		common.Text("Provided no arguments, returns a non-negative pseudo-random Int."),
		common.Text("Provided one argument, returns a non-negative pseudo-random Int in [0,max)."),
		common.Text("Provided two arguments, returns a pseudo-random Int in [min,max)."),
	),
	Validator: All(
		AtMostNArgs(2),
		AllArgs(TypeOf(ZeroInt())),
...
var FuncPower = execution.Function{
	...
	Description: common.Text("Returns x to the power of the exponent."),
	Validator: All(
		ExactlyNArgs(2),
		AllArgs(TypeOf(ZeroFloat())),
	),
...
var FuncLower = execution.Function{
	...
	Description: common.Text("Returns the text in lowercase."),
	Validator: All(
		ExactlyNArgs(1),
...
var FuncUpper = execution.Function{
	...
	Description: common.Text("Returns the text in uppercase."),
	Validator: All(
		ExactlyNArgs(1),
		Arg(0, TypeOf(ZeroString())),
	),
...
var FuncCapitalize = execution.Function{
	...
	Description: common.Text("Returns the text with all words capitalized."),
	Validator: All(
		ExactlyNArgs(1),
		Arg(0, TypeOf(ZeroString())),
	),
...
var FuncReverse = execution.Function{
	...
	Description: common.List(
		common.Text("Provided a String, returns the reversed string."),
		common.Text("Provided a Tuple, returns the elements in reverse order."),
	),
	Validator: All(
		ExactlyNArgs(1),
		Arg(0,
...
var FuncSubstring = execution.Function{
	...
	Description: common.List(
		common.Text("Provided two arguments, returns word[begin:]."),
		common.Text("Provided three arguments, returns word[begin:end]."),
	),
	Validator: All(
		AtLeastNArgs(2),
		AtMostNArgs(3),
...
var FuncMatchRegexp = execution.Function{
	...
	Description: common.Text("Returns the first match of regexp in the text."),
	Validator: All(
		ExactlyNArgs(2),
...
var FuncReplace = execution.Function{
	...
	Description: common.Text("Returns the text with all the instances of old replaced with new."),
	Validator: All(
		ExactlyNArgs(3),
		AllArgs(TypeOf(ZeroString())),
	),
...
var FuncHasPrefix = execution.Function{
	...
	Description: common.Text("Returns whether the text begins with prefix."),
	Validator: All(
		ExactlyNArgs(2),
		AllArgs(TypeOf(ZeroString())),
	),
...
var FuncHasSuffix = execution.Function{
	...
	Description: common.Text("Returns whether the text ends with suffix."),
	Validator: All(
		ExactlyNArgs(2),
		AllArgs(TypeOf(ZeroString())),
	),
...
var FuncContains = execution.Function{
	...
	Description: common.List(
		common.Text("Provided a String, returns whether it contains the given substring."),
		common.Text("Provided a Tuple, returns whether it contains the given element. "),
	),
	Validator: All(
		ExactlyNArgs(2),
		OneOf(
...
var FuncIndex = execution.Function{
	...
	Description: common.List(
		common.Text("Provided a String, returns the index of the substring in the text, or -1 if the text doesn't contain it."),
		common.Text("Provided a Tuple, returns the index of the element in the tuple, or -1 if the tuple doesn't contain it."),
	),
	Validator: All(
		ExactlyNArgs(2),
		OneOf(
...
var FuncNth = execution.Function{
	...
	Description: common.Text("Returns the element with index n in the tuple."),
	Validator: All(
		ExactlyNArgs(2),
...
var FuncLength = execution.Function{
	...
	Description: common.Text("Returns the length of the given Tuple or String."),
	Validator: All(
		ExactlyNArgs(1),
		Arg(0,
			SingleOneOf(
...
var FuncNow = execution.Function{
	...
	Description: common.Text("Returns the current time."),
...
var FuncStringJoin = execution.Function{
	...
	Description: common.Text("Returns the elements of the string tuple joined into a string separated by the delimiter."),
	Validator: All(
		ExactlyNArgs(2),
		Arg(0, TypeOf(ZeroString())),
		Arg(1, TypeOf(ZeroTuple())),
...
var FuncAdd = execution.Function{
	...
	Description: common.Text("Returns the sum of the two arguments."),
	Validator: OneOf(
		All(
			AtLeastNArgs(1),
			AtMostNArgs(2),
...
var FuncSubtract = execution.Function{
	...
	Description: common.Text("Returns the difference between the two arguments."),
	Validator: OneOf(
		All(
			AtLeastNArgs(1),
			AtMostNArgs(2),
...
var FuncMultiply = execution.Function{
	...
	Description: common.Text("Returns the dot product of the two arguments."),
	Validator: All(
		ExactlyNArgs(2),
		OneOf(
			AllArgs(TypeOf(ZeroInt())),
...
var FuncDivide = execution.Function{
	...
	Description: common.Text("Returns the division of the two arguments."),
	Validator: All(
		ExactlyNArgs(2),
		OneOf(
			AllArgs(TypeOf(ZeroInt())),
...
var FuncDuration = execution.Function{
	...
	Description: common.List(
		common.Text("Provided one argument, parses the duration as in https://golang.org/pkg/time/#ParseDuration"),
		common.Text("Provided two arguments, returns the duration equal to count of unit."),
	),
	Validator: OneOf(
		All(
			ExactlyNArgs(1),
...
var FuncCoalesce = execution.Function{
	...
	Description: common.List(
		common.Text("Returns the first non-null argument, or null if there isn't any."),
	),
	Validator: All(
		AtLeastNArgs(1),
	),
...
var FuncNullIf = execution.Function{
	...
	Description: common.List(
		common.Text("Returns null if target equals to_replace, returns target otherwise."),
	),
	Validator: All(
		ExactlyNArgs(2),
	),
