...
func (node *Map) Get(variables common.Variables) (RecordStream, error) {
...
func (stream *MappedStream) Next() (*Record, error) {
	...
	fieldNames := make([]common.VariableName, 0)
	outValues := make(map[common.VariableName]common.Value)
